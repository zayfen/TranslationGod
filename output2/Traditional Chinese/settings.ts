export default {
  ...
  "app.settings.menuMap.binding": "帳號綁定",
  "app.settings.menuMap.notification": "新消息通知",
  "app.settings.basic.avatar": "頭像",
  "app.settings.basic.change-avatar": "更換頭像",
  "app.settings.basic.email": "信箱",
  "app.settings.basic.email-message": "請輸入您的電子郵箱！",
  "app.settings.basic.nickname": "綽號",
  "app.settings.basic.nickname-message": "請輸入您的暱稱！",
  ...
  "app.settings.basic.phone": "聯絡電話",
  "app.settings.basic.phone-message": "請輸入您的聯絡電話！",
  "app.settings.basic.update": "更新基本資訊",
  "app.settings.security.strong": "強",
  "app.settings.security.medium": "中",
  "app.settings.security.weak": "弱",
  "app.settings.security.password": "帳戶密碼",
  ...
  "app.settings.security.email": "備用電郵",
  ...
  "app.settings.binding.taobao-description": "當前未綁定淘寶帳號",
  ...
  "app.settings.notification.password": "帳戶密碼",
  ...
  "robot.check.blacklist": "該MAC地址已被加入黑名單，請聯繫普渡公司處理"
}